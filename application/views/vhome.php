            ...
            <section class="mt-lg-5">
                <div class="col-lg-12 col-md-6 mb-4">
                    <div class="card">
                        ...
                        <div class="col-lg-12 col-md-6 card-body text-center">
                            <?php 
                            error_reporting(0);
                    ...
                    <div class="col-lg-12 col-md-6 mb-4">
                        ...
                        <!--Panel-->
                            ...
                            <div class="col-sm-12" align="center">
                                ...
                                <button type="button" class="btn btn-outline-primary waves-effect" id="save" onclick="insert();"><i class="fa fa-hdd-o"></i> Simpan</button>
                            </div>
                </div>
